 ...
 */
#define GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x) \
...
@     elif ps.size == 1 or ps.size == 2 or ps.size == 4 or ps.size == 8:
	 ...
	 */
	return GP_GET_BITS1_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
...
@     elif ps.size <= 10 or ps.size == 12 or ps.size == 16:
	 ...
	 */
	return GP_GET_BITS2_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
		*(GP_PIXEL_ADDR_{{ ps.suffix }}(c, x, y)));
@     elif ps.size <= 18 or ps.size == 20 or ps.size == 24:
	 ...
	 *       pixel_size mod 8 and maximal size thus is pixel_size + 7
	 */
	return GP_GET_BITS3_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
		*(GP_PIXEL_ADDR_{{ ps.suffix }}(c, x, y)));
@     elif ps.size <= 23 or ps.size == 25 or ps.size == 26 or ps.size == 28 or ps.size == 32:
	 ...
	 *       pixel_size mod 8 and maximal size thus is pixel_size + 7
	 */
	return GP_GET_BITS4_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
		*(GP_PIXEL_ADDR_{{ ps.suffix }}(c, x, y)));
@     else:
...
@     elif ps.size == 1 or ps.size == 2 or ps.size == 4 or ps.size == 8:
	 ...
	 * The full list = {1, 2, 4, 8}
	 */
	GP_SET_BITS1_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
...
@     elif ps.size <= 10 or ps.size == 12 or ps.size == 16:
	 ...
	 *       pixel_size mod 8 and maximal size thus is pixel_size + 7
	 */
	GP_SET_BITS2_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
	                     GP_PIXEL_ADDR_{{ ps.suffix }}(c, x, y), p);
@     elif ps.size <= 18 or ps.size == 20 or ps.size == 24:
	/*
	 * The pixel is stored in two or three bytes
	 ...
	 *       pixel_size mod 8 and maximal size thus is pixel_size + 7
	 */
	GP_SET_BITS3_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
	                     GP_PIXEL_ADDR_{{ ps.suffix }}(c, x, y), p);
@     elif ps.size <= 23 or ps.size == 25 or ps.size == 26 or ps.size == 28 or ps.size == 32:
	/*
	 * The pixel is stored in three or four bytes
	 ...
	 *       pixel_size mod 8 and maximal size thus is pixel_size + 7
	 */
	GP_SET_BITS4_ALIGNED(GP_PIXEL_ADDR_SHIFT_{{ ps.suffix }}(x), {{ ps.size }},
	                     GP_PIXEL_ADDR_{{ ps.suffix }}(c, x, y), p);
@     else:
	#error not implemented
@     end
